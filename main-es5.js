...
var routingComponents = [_empresas_solicitud_empresa_solicitud_empresa_component__WEBPACK_IMPORTED_MODULE_3__["SolicitudEmpresaComponent"], _empresas_detalle_solicitudes_empresa_detalle_solicitudes_empresa_component__WEBPACK_IMPORTED_MODULE_4__["DetalleSolicitudesEmpresaComponent"]];
...
var DetalleSolicitudesEmpresaComponent = /** @class */ (function () {
    function DetalleSolicitudesEmpresaComponent() {
    }
    DetalleSolicitudesEmpresaComponent.prototype.ngOnInit = function () {
    };
    ...
    return DetalleSolicitudesEmpresaComponent;
}());
...
var RegistroEmpresaComponent = /** @class */ (function () {
    function RegistroEmpresaComponent(fb, registroEmpresaService, router) {
        this.fb = fb;
        this.registroEmpresaService = registroEmpresaService;
        this.router = router;
        this.cargando = false;
    }
    RegistroEmpresaComponent.prototype.ngOnInit = function () {
        this.initForm();
    ...
    RegistroEmpresaComponent.prototype.initForm = function () {
    ...
    RegistroEmpresaComponent.prototype.obtenerRecursos = function () {
        var _this = this;
        this.cargando = true;
        this.registroEmpresaService.getObtenerMunicipios().subscribe(function (res) {
            _this.municipios = res;
        }, function (error) {
        ...
        this.registroEmpresaService.getObtenerSectoresEconomicosEmpresa().subscribe(function (res) {
            _this.sectoresEconomicos = res;
    ...
    RegistroEmpresaComponent.prototype.creaEmpresa = function () {
        var _this = this;
        this.cargando = true;
        if (this.registroForm.valid) {
            ...
            body_1.nit = this.registroForm.get('nit').value;
            body_1.nombre = this.registroForm.get('nombreEmpresa').value;
            body_1.numeroEmpleados = this.registroForm.get('nEmpleados').value;
            body_1.idSectorEconomico = this.registroForm.get('sectorEconomico').value;
            body_1.telefono = this.registroForm.get('telefono').value;
            body_1.email = this.registroForm.get('correo').value;
            body_1.direccion = this.registroForm.get('direccion').value;
            body_1.idMunicipio = this.registroForm.get('municipio').value;
            this.registroEmpresaService.getCrearEmpresa(body_1).subscribe(function (res) {
                var icono = '';
                var mensaje = '';
                if (res.id !== 0) {
                    var datosEmpresa = {
                        idEmpresa: res.id,
                        nombreEmpresa: body_1.nombre
                    };
                ...
                sweetAlert__WEBPACK_IMPORTED_MODULE_5___default()({
                    ...
                    .then(function (willDelete) {
                    if (willDelete) {
                        _this.router.navigate(['/solicitud-empresa']);
                    }
                    else {
                    }
                });
    ...
    RegistroEmpresaComponent.prototype.cancelar = function () {
        sessionStorage.removeItem('nit');
        sessionStorage.removeItem('datos-empresa');
        this.registroForm.reset();
        this.router.navigate(['/solicitud-empresa']);
    };
    RegistroEmpresaComponent.ctorParameters = function () { return [
    ...
    return RegistroEmpresaComponent;
}());
...
var RegistroEmpresaService = /** @class */ (function () {
    function RegistroEmpresaService(http) {
        this.http = http;
    }
    RegistroEmpresaService.prototype.getObtenerMunicipios = function () {
    ...
    RegistroEmpresaService.prototype.getObtenerSectoresEconomicosEmpresa = function () {
        return this.http.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].maestros +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsMaestros"].getObtenerSectoresEconomicosEmpresa);
    };
    RegistroEmpresaService.prototype.getCrearEmpresa = function (body) {
    ...
    RegistroEmpresaService.ctorParameters = function () { return [
...
var SolicitudEmpresaComponent = /** @class */ (function () {
    function SolicitudEmpresaComponent(solicitudEmpresaService, toastr, router) {
    ...
    SolicitudEmpresaComponent.prototype.ngOnInit = function () {
        if (sessionStorage.getItem('datos-empresa')) {
            var empresa = JSON.parse(sessionStorage.getItem('datos-empresa'));
    ...
    SolicitudEmpresaComponent.prototype.ValidarExistencia = function () {
        var _this = this;
        sessionStorage.removeItem('datos-empresa');
        sessionStorage.removeItem('solicitud-practicante');
        this.solicitudEmpresaService.getValidarExisteEmpresa(this.nit).subscribe(function (res) {
            _this.idEmpresa = res.idEmpresa;
            _this.nombre = res.nombreEmpresa;
            _this.buscarEmpresa();
            sessionStorage.setItem('nit', _this.nit);
    ...
    SolicitudEmpresaComponent.prototype.buscarEmpresa = function () {
        var _this = this;
        sessionStorage.removeItem('datos-empresa');
        sessionStorage.removeItem('solicitud-practicante');
        if (this.idEmpresa === 0) {
            ...
            sweetAlert__WEBPACK_IMPORTED_MODULE_7___default()({
                ...
                .then(function (willDelete) {
                if (willDelete) {
                    _this.router.navigate(["registro-de-empresa"]);
                }
                else {
                }
            });
    ...
    SolicitudEmpresaComponent.prototype.EnviarSolicitud = function () {
        var _this = this;
        var body = {
            listaSolicitudes: this.solicitudes
        };
        this.solicitudEmpresaService.postEnviarSolicitudEmpresa(body).subscribe(function (res) {
    ...
    SolicitudEmpresaComponent.prototype.eliminarSolicitud = function (data) {
        var _this = this;
        sweetAlert__WEBPACK_IMPORTED_MODULE_7___default()({
            ...
            if (willDelete) {
                _this.tabla = false;
                for (var index = 0; index < _this.solicitudes.length; index++) {
                    var element = _this.solicitudes[index];
                    if (element.idSolicitud === data.idSolicitud) {
                        _this.solicitudes.splice(0, data.idSolicitud);
                        sessionStorage.setItem('solicitud-practicante', JSON.stringify(_this.solicitudes));
                        _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.solicitudes);
                ...
                _this.solicitudes = _this.solicitudes;
            }
            else {
            }
        });
    };
    SolicitudEmpresaComponent.prototype.editarSolicitud = function (dataEdit) {
        sessionStorage.setItem('SolicitudEditar', JSON.stringify(dataEdit));
        this.router.navigate(['solicitar-practicante']);
    };
    SolicitudEmpresaComponent.prototype.cancelar = function () {
        this.nit = '';
        this.router.navigate(['/inicio']);
        sessionStorage.removeItem('datos-empresa');
        sessionStorage.removeItem('solicitud-practicante');
    };
    SolicitudEmpresaComponent.ctorParameters = function () { return [
...
var SolicitudEmpresaService = /** @class */ (function () {
    function SolicitudEmpresaService(http) {
        this.http = http;
    }
    SolicitudEmpresaService.prototype.getValidarExisteEmpresa = function (nit) {
        ...
        return this.http.get(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            ...
            _utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsEmpresa"].getObtenerDatosEmpresa, { params: params });
    };
    SolicitudEmpresaService.prototype.postEnviarSolicitudEmpresa = function (body) {
    ...
    SolicitudEmpresaService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return SolicitudEmpresaService;
}());
...
var SolicitudPracticanteComponent = /** @class */ (function () {
    function SolicitudPracticanteComponent(fb, serviceSolicitudPracticante, router) {
        this.fb = fb;
    ...
    SolicitudPracticanteComponent.prototype.ngOnInit = function () {
    ...
    SolicitudPracticanteComponent.prototype.ngDoCheck = function () {
        this.cargando = sessionStorage.getItem('cargando') ? true : false;
    };
    SolicitudPracticanteComponent.prototype.editSolicitud = function () {
        var _this = this;
        setTimeout(function () {
            if (sessionStorage.getItem('SolicitudEditar') && _this.programas) {
                _this.btnEditar = true;
                var body = JSON.parse(sessionStorage.getItem('SolicitudEditar'));
                _this.registroForm.get('descripcion').setValue(body.descripcion);
                _this.registroForm.get('perfil').setValue(_this.programas[_this.getItem(body.idProgramaSolicitado, _this.programas)]);
                _this.ValidarProgramasDisponibles(body.idProgramaSolicitado);
                _this.registroForm.get('tipoVinculacion').setValue(_this.tipoVinculacion[_this.getItem(body.idTipoContrato, _this.tipoVinculacion)]);
                _this.registroForm.get('fechaInicio').setValue(body.fechaInicio);
                _this.registroForm.get('nombreEncargado').setValue(body.nombrePersonaEncargada);
                _this.registroForm.get('cargoEncargado').setValue(body.cargoPersonaEncargada);
                _this.registroForm.get('telefono').setValue(body.telefonoPersonaEncargada);
                _this.registroForm.get('correo').setValue(body.emailPersonaEncargada);
                _this.registroForm.get('cargoDesempeñar').setValue(body.nombreCargoPracticante);
                sessionStorage.removeItem('cargando');
            }
        }, 1000);
    };
    SolicitudPracticanteComponent.prototype.getItem = function (id, array) {
    ...
    SolicitudPracticanteComponent.prototype.initForm = function () {
        this.registroForm = this.fb.group({
    ...
    SolicitudPracticanteComponent.prototype.ObtenerProgramas = function () {
        var _this = this;
        this.serviceSolicitudPracticante.getProgramas().subscribe(function (res) {
            _this.programas = res;
        });
    };
    SolicitudPracticanteComponent.prototype.ObtenerTipoVinculacion = function () {
        var _this = this;
        this.serviceSolicitudPracticante.getTipoVinculacion().subscribe(function (res) {
            _this.tipoVinculacion = res;
            sessionStorage.removeItem('cargando');
        });
    };
    SolicitudPracticanteComponent.prototype.ValidarProgramasDisponibles = function (idPrograma) {
        var _this = this;
        sessionStorage.setItem('cargando', 'true');
        var idEmpresa = JSON.parse(sessionStorage.getItem('datos-empresa')).idEmpresa;
        this.serviceSolicitudPracticante.getExistenEstudiantesDisponiblesPrograma(idPrograma, idEmpresa).subscribe(function (res) {
            sessionStorage.removeItem('cargando');
            _this.disponible = res.hayEstudiantesDisponibles;
            if (!_this.disponible) {
                _this.alert = _this.disponible;
                sweetAlert__WEBPACK_IMPORTED_MODULE_5___default()({
                    icon: "warning",
                    title: "Lo sentimos",
                    ...
                    if (willDelete) {
                        sessionStorage.setItem('cargando', 'true');
                        _this.serviceSolicitudPracticante.postCrearSolicitudEmpresaEnEspera(idPrograma, idEmpresa).subscribe(function (res) {
                            sessionStorage.removeItem('cargando');
                            sweetAlert__WEBPACK_IMPORTED_MODULE_5___default()({
                                title: "",
    ...
    SolicitudPracticanteComponent.prototype.guardarSolicitud = function () {
        sessionStorage.setItem('cargando', 'true');
        var idEmpresa = JSON.parse(sessionStorage.getItem('datos-empresa')).idEmpresa;
        var body = {
            idEmpresa: idEmpresa,
        ...
        if (this.registroForm.valid) {
            if (sessionStorage.getItem('solicitud-practicante')) {
                var solicitudes = JSON.parse(sessionStorage.getItem('solicitud-practicante'));
    ...
    SolicitudPracticanteComponent.prototype.editarSolicitud = function () {
        sessionStorage.setItem('cargando', 'true');
        var idEmpresa = JSON.parse(sessionStorage.getItem('datos-empresa')).idEmpresa;
        var bodyEdit = JSON.parse(sessionStorage.getItem('SolicitudEditar'));
        var body = {
            idEmpresa: idEmpresa,
            idProgramaSolicitado: this.registroForm.get('perfil').value.id,
            programa: this.registroForm.get('perfil').value.descripcion,
        ...
        if (this.registroForm.valid) {
            var solicitudes = JSON.parse(sessionStorage.getItem('solicitud-practicante'));
            for (var index = 0; index < solicitudes.length; index++) {
                var element = solicitudes[index];
    ...
    SolicitudPracticanteComponent.prototype.cancelar = function () {
        this.registroForm.reset();
        sessionStorage.removeItem('SolicitudEditar');
        this.router.navigate(['/solicitud-empresa']);
    };
    SolicitudPracticanteComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    ...
    return SolicitudPracticanteComponent;
}());
...
var SolicitudPracticanteService = /** @class */ (function () {
    function SolicitudPracticanteService(http) {
        this.http = http;
    }
    SolicitudPracticanteService.prototype.getProgramas = function () {
        return this.http.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].maestros +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsMaestros"].getObtenerProgramas);
    };
    SolicitudPracticanteService.prototype.getTipoVinculacion = function () {
        return this.http.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].maestros +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsMaestros"].getObtenerTiposVinculacionEmpresa);
    };
    SolicitudPracticanteService.prototype.getExistenEstudiantesDisponiblesPrograma = function (idPrograma, idEmpresa) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('idPrograma', idPrograma)
            .set('idEmpresa', idEmpresa);
        return this.http.get(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].estudiante +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsEstudiante"].getExistenEstudiantesDisponiblesPrograma, { params: params });
    };
    SolicitudPracticanteService.prototype.postCrearSolicitudEmpresaEnEspera = function (idPrograma, idEmpresa) {
        var body = {
            idEmpresa: idEmpresa,
            idPrograma: idPrograma
        };
    ...
    SolicitudPracticanteService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return SolicitudPracticanteService;
}());
...
var ContenedorEstudiantesComponent = /** @class */ (function () {
    function ContenedorEstudiantesComponent() {
        this.select = 1;
        this.idPrograma = 0;
    }
    ContenedorEstudiantesComponent.prototype.ngOnInit = function () {
        this.idPrograma;
    };
    ...
    return ContenedorEstudiantesComponent;
}());
...
var FormularioEstudianteComponent = /** @class */ (function () {
    function FormularioEstudianteComponent(serviseFormulario, toastr, fb) {
    ...
    FormularioEstudianteComponent.prototype.ngOnInit = function () {
        sessionStorage.setItem('cargando', 'true');
        this.initForm();
        this.obtenerMunicipios();
    };
    FormularioEstudianteComponent.prototype.ngDoCheck = function () {
        this.cargando = sessionStorage.getItem('cargando') ? true : false;
    };
    FormularioEstudianteComponent.prototype.initForm = function () {
        this.registroForm = this.fb.group({
    ...
    FormularioEstudianteComponent.prototype.obtenerMunicipios = function () {
        var _this = this;
        this.serviseFormulario.getObtenerMunicipios().subscribe(function (res) {
            sessionStorage.removeItem('cargando');
            _this.municipios = res;
        });
    };
    FormularioEstudianteComponent.prototype.validarRequisitos = function () {
        var _this = this;
        ...
        this.serviseFormulario.getValidarRequisitosEstudiante(this.estudiante.numeroIdentificacion).subscribe(function (res) {
            var validacion = res;
            if (validacion.aproboCursoPrepractica && validacion.aproboPerfilamiento) {
                _this.estudiante.fechaCursoPrepractica = validacion.fechaCursoPrepractica;
                _this.estudiante.aproboCursoPrepractica = validacion.aproboCursoPrepractica;
                _this.estudiante.fechaPerfilamiento = validacion.fechaPerfilamiento;
                _this.estudiante.aproboPerfilamiento = validacion.aproboPerfilamiento;
                _this.crearEstudiante(_this.estudiante);
            }
    ...
    FormularioEstudianteComponent.prototype.crearEstudiante = function (body) {
        var _this = this;
        sessionStorage.setItem('cargando', 'true');
        if (this.registroForm.valid) {
            this.serviseFormulario.postCrearEstudiante(body).subscribe(function (res) {
                sessionStorage.removeItem('cargando');
                if (res.id !== 0) {
                    _this.subirArchivo(res.id, body.nombreCompleto, body.numeroIdentificacion);
                }
                else {
                    sweetAlert__WEBPACK_IMPORTED_MODULE_5___default()({
                        title: "",
    ...
    FormularioEstudianteComponent.prototype.onFileSelect = function (event) {
    ...
    FormularioEstudianteComponent.prototype.subirArchivo = function (idEstudiante, nombreCompleto, numeroIdentificacion) {
        var _this = this;
        sessionStorage.setItem('cargando', 'true');
        ...
        this.serviseFormulario.postSubirArchivo(formData).subscribe(function (res) {
            sessionStorage.removeItem('cargando');
    ...
    FormularioEstudianteComponent.prototype.cancelar = function () {
        this.alerta.emit(false);
        this.select.emit(1);
    };
    FormularioEstudianteComponent.ctorParameters = function () { return [
    ...
    return FormularioEstudianteComponent;
}());
...
var FormularioEstudianteService = /** @class */ (function () {
    function FormularioEstudianteService(http) {
        this.http = http;
    }
    FormularioEstudianteService.prototype.getValidarRequisitosEstudiante = function (identificacion) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('identificacion', identificacion);
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].estudiante +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsEstudiante"].getValidarRequisitosEstudiante, { params: params });
    };
    FormularioEstudianteService.prototype.getObtenerMunicipios = function () {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].maestros +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsMaestros"].getObtenerMunicipios);
    };
    FormularioEstudianteService.prototype.postCrearEstudiante = function (body) {
    ...
    FormularioEstudianteService.prototype.postSubirArchivo = function (formData) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
    ...
    FormularioEstudianteService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return FormularioEstudianteService;
}());
...
var RegistroEstudianteComponent = /** @class */ (function () {
    function RegistroEstudianteComponent(serviseRegistro, router) {
    ...
    RegistroEstudianteComponent.prototype.ngOnInit = function () {
        sessionStorage.setItem('cargando', 'true');
        this.getFacultades();
    };
    RegistroEstudianteComponent.prototype.ngDoCheck = function () {
        this.cargando = sessionStorage.getItem('cargando') ? true : false;
    };
    RegistroEstudianteComponent.prototype.requisito = function (value) {
        for (var index = 0; index < this.programas.length; index++) {
            var element = this.programas[index];
            if (element.id === value) {
                this.requisitos = element.requisitosProgramaPractica;
            }
        }
    };
    RegistroEstudianteComponent.prototype.getFacultades = function () {
        var _this = this;
        this.serviseRegistro.getFacultades().subscribe(function (res) {
            sessionStorage.removeItem('cargando');
            _this.facultades = res;
        }, function (error) {
            sessionStorage.removeItem('cargando');
    ...
    RegistroEstudianteComponent.prototype.getProgramasporFacultad = function () {
        var _this = this;
        sessionStorage.setItem('cargando', 'true');
        var id = this.idFacultad;
        this.serviseRegistro.getProgramaPorFacultad(id).subscribe(function (res) {
            _this.programas = res;
            sessionStorage.removeItem('cargando');
        }, function (error) {
            sessionStorage.removeItem('cargando');
    ...
    RegistroEstudianteComponent.prototype.onSubmit = function () {
        this.select.emit(2);
        this.idPrograma.emit(this.idpro);
    };
    RegistroEstudianteComponent.ctorParameters = function () { return [
    ...
    return RegistroEstudianteComponent;
}());
...
var RegistroEstudianteService = /** @class */ (function () {
    function RegistroEstudianteService(http) {
        this.http = http;
    }
    RegistroEstudianteService.prototype.getFacultades = function () {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]()
            .set('SCOrigen', src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["headersRequest"].SCOrigen);
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].maestros +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsMaestros"].getObtenerFacultades, { headers: headers });
    };
    RegistroEstudianteService.prototype.getProgramaPorFacultad = function (idFacultad) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('idFacultad', idFacultad);
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].endpoint +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["apis"].maestros +
            src_utils_const__WEBPACK_IMPORTED_MODULE_4__["endpointsMaestros"].getObtenerProgramasPorFacultad, { params: params });
    };
    RegistroEstudianteService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return RegistroEstudianteService;
}());
...
var InicioComponent = /** @class */ (function () {
    ...
    InicioComponent.prototype.goToPage = function (pagename) {
...
var EmpresasService = /** @class */ (function () {
    ...
    EmpresasService.prototype.obtenerSolicitudesEmpresa = function () {
        return [];
    };
...
var NotificacionComponent = /** @class */ (function () {
    ...
    NotificacionComponent.prototype.onSubmit = function () {
        this.router.navigate(["/" + this.ruta]);
    };
    NotificacionComponent.prototype.close = function () {
        this.closeNotificacion.emit(true);
    };
    NotificacionComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
